...
// Variables globales
int dutyCycle = 0;  // Duty cycle inicial 
...
void PWMInit(){
  ...
  Serial.println("Control del duty cycle:");
  Serial.println("Usa '+' para incrementar y '-' para reducir el duty cycle.");
  Serial.print("Duty cycle inicial: ");
